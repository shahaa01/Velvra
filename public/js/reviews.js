    ...
    async loadReviews(page = 1, append = false) {
        try {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'Failed to load reviews. Please refresh the page and try again.',
                toast: true,
                position: 'top-end',
            ...
            if (response.ok) {
                ...
                if (data.error && data.error.includes('already reviewed')) {
                    Swal.fire({
                        ...
                        text: 'You have already reviewed this product. You can edit your existing review instead.',
                        toast: true,
                        position: 'top-end',
                        showConfirmButton: false,
                        timer: 4000,
                ...
                } else if (data.error && data.error.includes('purchased and received')) {
                    Swal.fire({
                        icon: 'warning',
                        title: 'Order Required',
                        text: 'You can only review products you have purchased and received. Please order this product first.',
                        toast: true,
                        position: 'top-end',
                        showConfirmButton: false,
                        timer: 5000,
    ...
    async editReview(reviewId) {
        try {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'Failed to load review for editing. Please try again.',
                toast: true,
                position: 'top-end',
                showConfirmButton: false,
                timer: 3000,
